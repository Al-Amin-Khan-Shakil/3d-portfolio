...
# 📖 3D Portfolio <a name="about-project"></a>

**3D Portfolio** is my portfolio website to showcase my projects, skills, experiences and achivements.
...
```sh
  cd my-folder
  git clone git@github.com:Al-Amin-Khan-Shakil/3d-portfolio.git
```
...
Feel free to check the [issues page](https://github.com/Al-Amin-Khan-Shakil/3d-portfolio/issues).
...
I would like to thank [Nessrine](https://github.com/Nessrine88) for this project idea.
